		...
		<!-- Footer -->
			...
			<div class="footer-center">
				<div>
					...
					<p style="font-size:20px">Mangalore Institute of Technology and Engineering<span>Moodabidre </span></p>
				</div>
				<div>
					<i class="fa fa-phone"></i>
					<p style="font-size:20px">8376020168</p>
				</div>
				<div>
					<i class="fa fa-envelope"></i>
					<p style="font-size:20px"><a href="mailto:prem49810@gmail.com" style="color:white">prem49810@gmail.com</a></p>
				</div>
			</div>
